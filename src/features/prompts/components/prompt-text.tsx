    ...
    <div>
      ...
      {shouldShowToggle && (
        <button
          ...
          className="inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-full p-3 text-sm font-semibold text-gray-600 transition hover:text-gray-900"
        >
          <ChevronDown
